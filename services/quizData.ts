// 答题模式 - 全局题库
// 常规模型每个 5 题；少儿兴趣模型每个 8 题，进入答题模式时随机抽取 5 题
...
// 少儿兴趣题库：题目以观察、科普和良好习惯为主，适合小学生作答。
const LANJINGLING_QUESTIONS: QuizQuestion[] = [
  { id: 'lanjingling-1', modelUrl: '/models/lanjingling.glb', subject: '蓝精灵', question: '蓝精灵身上最醒目的颜色是什么？', options: ['蓝色', '橙色'], correctIndex: 0, explanation: '蓝精灵最醒目的特点就是蓝色的身体，所以叫“蓝精灵”。' },
  { id: 'lanjingling-2', modelUrl: '/models/lanjingling.glb', subject: '蓝精灵', question: '想看清蓝精灵模型的背面，可以怎么做？', options: ['闭上眼睛', '转动三维模型'], correctIndex: 1, explanation: '转动三维模型，就能从前、后、左、右等不同方向观察它。' },
  { id: 'lanjingling-3', modelUrl: '/models/lanjingling.glb', subject: '蓝精灵', question: '蓝色最容易让人想到哪两样自然景物？', options: ['蓝天和大海', '火焰和太阳'], correctIndex: 0, explanation: '晴朗的天空和清澈的大海常常呈现蓝色。' },
  { id: 'lanjingling-4', modelUrl: '/models/lanjingling.glb', subject: '蓝精灵', question: '小伙伴一起完成任务时，哪种做法更好？', options: ['互相争吵', '互相帮助'], correctIndex: 1, explanation: '互相帮助、分工合作，能让大家更顺利地完成任务。' },
  { id: 'lanjingling-5', modelUrl: '/models/lanjingling.glb', subject: '蓝精灵', question: '在森林里游玩时，我们应该怎样对待花草？', options: ['爱护花草', '随意踩踏'], correctIndex: 0, explanation: '花草和树木是许多生物的家，我们应该爱护它们。' },
  { id: 'lanjingling-6', modelUrl: '/models/lanjingling.glb', subject: '蓝精灵', question: '蘑菇属于下面哪一类生物？', options: ['小动物', '真菌'], correctIndex: 1, explanation: '蘑菇属于真菌，不是植物，也不是小动物。' },
  { id: 'lanjingling-7', modelUrl: '/models/lanjingling.glb', subject: '蓝精灵', question: '看到野外不认识的蘑菇，正确做法是什么？', options: ['不随便采吃', '马上尝一口'], correctIndex: 0, explanation: '有些野生蘑菇有毒，不认识时不能随便采摘和食用。' },
  { id: 'lanjingling-8', modelUrl: '/models/lanjingling.glb', subject: '蓝精灵', question: '观察三维模型时，放大模型有什么用？', options: ['改变模型颜色', '看清细节'], correctIndex: 1, explanation: '放大模型可以帮助我们看清衣服、表情和造型等细节。' },
];

const NAILI_QUESTIONS: QuizQuestion[] = [
  { id: 'naili-1', modelUrl: '/models/naili.glb', subject: '奈李', question: '奈李属于哪一类食物？', options: ['水果', '蔬菜'], correctIndex: 0, explanation: '奈李是李子的一种，属于水果。' },
  { id: 'naili-2', modelUrl: '/models/naili.glb', subject: '奈李', question: '奈李通常长在哪里？', options: ['水里', '树上'], correctIndex: 1, explanation: '奈李是李树结出的果实，生长在树枝上。' },
  { id: 'naili-3', modelUrl: '/models/naili.glb', subject: '奈李', question: '奈李果实里面通常有什么？', options: ['果核', '贝壳'], correctIndex: 0, explanation: '奈李中间有一颗较硬的果核，吃的时候要小心。' },
  { id: 'naili-4', modelUrl: '/models/naili.glb', subject: '奈李', question: '吃新鲜奈李前，应该先做什么？', options: ['涂上颜料', '清洗干净'], correctIndex: 1, explanation: '水果食用前要用干净的水认真清洗。' },
  { id: 'naili-5', modelUrl: '/models/naili.glb', subject: '奈李', question: '奈李树开花以后，可能会慢慢长出什么？', options: ['奈李果实', '小石头'], correctIndex: 0, explanation: '花经过授粉后，花的一部分会慢慢发育成果实。' },
  { id: 'naili-6', modelUrl: '/models/naili.glb', subject: '奈李', question: '水果能为身体提供哪类营养？', options: ['塑料和玻璃', '维生素和膳食纤维'], correctIndex: 1, explanation: '水果通常含有维生素和膳食纤维，适量食用有益健康。' },
  { id: 'naili-7', modelUrl: '/models/naili.glb', subject: '奈李', question: '果农采摘奈李时，怎样做更合适？', options: ['轻拿轻放', '用力乱扔'], correctIndex: 0, explanation: '轻拿轻放可以减少碰伤，让果实保存得更好。' },
  { id: 'naili-8', modelUrl: '/models/naili.glb', subject: '奈李', question: '吃奈李时，遇到坚硬的果核应该怎么做？', options: ['直接吞下', '吐出果核'], correctIndex: 1, explanation: '坚硬的果核不适合吞咽，吃的时候要小心取出。' },
];

const NAILIGUOZI_QUESTIONS: QuizQuestion[] = [
  { id: 'nailiguozi-1', modelUrl: '/models/nailiguozi.glb', subject: '奈李果子', question: '奈李果子属于哪一类食物？', options: ['水果', '玩具'], correctIndex: 0, explanation: '奈李果子是李子类水果，可以用来观察果实的形状和颜色。' },
  { id: 'nailiguozi-2', modelUrl: '/models/nailiguozi.glb', subject: '奈李果子', question: '奈李果子一般长在哪里？', options: ['书包里', '树上'], correctIndex: 1, explanation: '奈李果子是李树结出的果实，通常长在树枝上。' },
  { id: 'nailiguozi-3', modelUrl: '/models/nailiguozi.glb', subject: '奈李果子', question: '吃奈李果子前，最好先做什么？', options: ['清洗干净', '涂上颜料'], correctIndex: 0, explanation: '新鲜水果入口前要洗干净，这样更卫生。' },
  { id: 'nailiguozi-4', modelUrl: '/models/nailiguozi.glb', subject: '奈李果子', question: '奈李果子中间通常会有什么？', options: ['小铃铛', '果核'], correctIndex: 1, explanation: '李子类水果中间一般有一颗较硬的果核，吃的时候要注意。' },
  { id: 'nailiguozi-5', modelUrl: '/models/nailiguozi.glb', subject: '奈李果子', question: '果子成熟后，味道通常会变得怎样？', options: ['更甜一些', '像石头一样硬'], correctIndex: 0, explanation: '很多水果成熟后会变软、变香，甜味也会更明显。' },
  { id: 'nailiguozi-6', modelUrl: '/models/nailiguozi.glb', subject: '奈李果子', question: '水果能给身体补充什么？', options: ['沙子和玻璃', '维生素和水分'], correctIndex: 1, explanation: '水果通常含有水分、维生素和膳食纤维，适量吃对身体有帮助。' },
  { id: 'nailiguozi-7', modelUrl: '/models/nailiguozi.glb', subject: '奈李果子', question: '采摘奈李果子时，哪种做法更好？', options: ['轻轻摘下', '用力乱扔'], correctIndex: 0, explanation: '轻拿轻放可以减少果子碰伤，也能保护树枝。' },
  { id: 'nailiguozi-8', modelUrl: '/models/nailiguozi.glb', subject: '奈李果子', question: '观察三维奈李果子模型时，放大模型可以看清什么？', options: ['天气预报', '果皮细节'], correctIndex: 1, explanation: '放大三维模型，可以更清楚地观察果皮、形状和颜色等细节。' },
];

const XIAOSHAOQING_QUESTIONS: QuizQuestion[] = [
  { id: 'xiaoshaoqing-1', modelUrl: '/models/xiaoshaoqing.glb', subject: '周田文旅 IP 形象「小韶卿」', question: '“小韶卿”是哪一个地方的文旅 IP 形象？', options: ['仁化县周田镇', '北京市'], correctIndex: 0, explanation: '“小韶卿”是仁化县周田镇的文旅 IP 形象。' },
  { id: 'xiaoshaoqing-2', modelUrl: '/models/xiaoshaoqing.glb', subject: '周田文旅 IP 形象「小韶卿」', question: '仁化县属于广东省的哪座城市？', options: ['深圳市', '韶关市'], correctIndex: 1, explanation: '仁化县位于广东省韶关市。' },
  { id: 'xiaoshaoqing-3', modelUrl: '/models/xiaoshaoqing.glb', subject: '周田文旅 IP 形象「小韶卿」', question: '周田镇的张屋古村属于哪一类景观？', options: ['历史古村落', '海底世界'], correctIndex: 0, explanation: '张屋古村保存着古建筑和历史文化，是一座古村落。' },
  { id: 'xiaoshaoqing-4', modelUrl: '/models/xiaoshaoqing.glb', subject: '周田文旅 IP 形象「小韶卿」', question: '张屋古村是哪位岭南诗人的祖居？', options: ['李白', '张九龄'], correctIndex: 1, explanation: '张屋古村是岭南诗人张九龄的祖居，传承着九龄文化。' },
  { id: 'xiaoshaoqing-5', modelUrl: '/models/xiaoshaoqing.glb', subject: '周田文旅 IP 形象「小韶卿」', question: '周田村流过的河流叫什么？', options: ['灵溪河', '黄河'], correctIndex: 0, explanation: '灵溪河流经周田村，当地还建设了美丽河道和景观步道。' },
  { id: 'xiaoshaoqing-6', modelUrl: '/models/xiaoshaoqing.glb', subject: '周田文旅 IP 形象「小韶卿」', question: '文旅 IP 形象可以帮助大家做什么？', options: ['忘记家乡故事', '认识当地文化和风景'], correctIndex: 1, explanation: '有趣的文旅 IP 形象能带大家认识当地的历史、文化和风景。' },
  { id: 'xiaoshaoqing-7', modelUrl: '/models/xiaoshaoqing.glb', subject: '周田文旅 IP 形象「小韶卿」', question: '参观古村时，哪种做法是正确的？', options: ['保护古建筑', '在墙上乱刻字'], correctIndex: 0, explanation: '古建筑记录着历史，参观时不能乱刻乱画，要一起保护它们。' },
  { id: 'xiaoshaoqing-8', modelUrl: '/models/xiaoshaoqing.glb', subject: '周田文旅 IP 形象「小韶卿」', question: '游览美丽河道时，我们应该怎样做？', options: ['把垃圾扔进河里', '把垃圾带走'], correctIndex: 1, explanation: '不乱扔垃圾，才能让河水更清、环境更美。' },
];
